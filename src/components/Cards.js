...
class Cards extends Component {
  constructor() {
    ...
    this.state = {
      phoneData: [
        { image: laptop1, name: "Sony", price: "1150 $" },
        { image: laptop2, name: "HP", price: "1050 $" },
        { image: laptop3, name: "Macbook", price: "1200 $" },
        { image: laptop4, name: "ASUS", price: "1100 $" },
      ],
    };
  }
  ...
  render() {
    return (
      <div className={styles.container}>
        ...
        {this.state.phoneData.map(phone => <Card key={v4()} image={phone.image} name={phone.name} price={phone.price} />)}
      </div>
    );
  }
}
